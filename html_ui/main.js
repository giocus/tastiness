      ...
      if (e.data.match(/^bin/)) {
        ...
        try {
          ...
          if (false) {
            ...
            return $('#luaOutput')[0].innerText = m.luaOutput;
          } else {
